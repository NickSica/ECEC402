...
HD_PWD='/home/nick/ECEC402/homework_2/led_drv_tb/led_drv_tb.runs/system_led_drv_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_led_drv_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_led_drv_0_0.tcl
