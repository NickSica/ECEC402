...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../led_drv_tb.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../led_drv_tb.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../led_drv_tb.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../led_drv_tb.gen/sources_1/bd/system/ipshared/34f8/hdl" \
