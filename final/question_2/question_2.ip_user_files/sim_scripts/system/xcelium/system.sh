...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../question_2.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../question_2.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../question_2.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../question_2.gen/sources_1/bd/system/ipshared/34f8/hdl" \
