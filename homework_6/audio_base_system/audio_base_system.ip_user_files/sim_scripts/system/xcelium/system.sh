...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../audio_base_system.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../audio_base_system.gen/sources_1/bd/system/ipshared/34f8/hdl" \
       +incdir+"../../../../audio_base_system.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../audio_base_system.gen/sources_1/bd/system/ipshared/34f8/hdl" \
