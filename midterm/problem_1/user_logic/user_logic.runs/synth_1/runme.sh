...
HD_PWD='/home/nick/ECEC402/midterm/problem_1/user_logic/user_logic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log user_logic.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source user_logic.tcl
